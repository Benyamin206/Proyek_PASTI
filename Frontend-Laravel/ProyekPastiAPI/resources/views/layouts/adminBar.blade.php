                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            {{-- <li><i class="fa fa-puzzle-piece"></i><a href="">Index</a></li> --}}
                            <li><i class="fa fa-id-badge"></i><a href="{{route('register_pemilik_kapal.form')}}">Tambah Akun Pemilik Kapal</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{route('nahkoda.index')}}">Index</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{route('nahkoda.tambah')}}">Tambah Nahkoda</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-bar-chart"></i>Rute</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-line-chart"></i><a href="{{route('rute.index')}}">Index</a></li>
                            <li><i class="menu-icon fa fa-area-chart"></i><a href="{{route('rute.tambah')}}">Tambah Rute</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-line-chart"></i><a href="{{route('jadwal.index')}}">Index</a></li>
                            <li><i class="menu-icon fa fa-area-chart"></i><a href="{{route('jadwal.tambah')}}">Tambah Jadwal</a></li>
                        </ul>
                    </li>
